...
void mock(string name, string p1, string p2, string p3, int k, int c) {
    ...
    if ((k <= 30) && (c >= 80)) {
        ...
        if ((p1 == "he") || (p1 == "they")) {
            ...
            cout << "One year later... \n" << endl;
            usleep(3000000);
            cout << name + " went to Canada to study Computer Engineering with " + p3 + " new girlfriend, Jenny. \n" << endl;
            usleep(3000000);
            cout << "3 years later... \n" << endl;
            usleep(3000000);
            cout << name + " eventually graduated and started working at Google as a Computing Specialist. \n";
            usleep(3000000);
            cout << name + " and Jenny got married and had a baby. The baby was a boy and they named him \"Alex\". \n";
            usleep(3000000);
            cout << name + " and Jenny continued to live a very happy life. \n" << endl;
            usleep(5000000);
...
void side_rizzler(string name, string p1, string p2, string p3, int k, int c) {
    ...
    //Girl scenario
        ...
        while (flag) {
            if (c <= 10) {
                flag = false;
                cout << "THE BOY REFUSES TO EVEN LOOK AT YOU BECAUSE YOUR CHARISMA IS TOO LOW. \n";
                usleep(6000000);
                cout << "Knowledge +0. Charisma -10. \n" << endl;
                usleep(2000000);
                c = c - 10;
...
void choice1_1(string name, string p1, string p2, string p3, int k, int c) {
    ...
    while (flag) {
        ...
        if (temp == 10) {
            flag = false;
            cout << "\n";
            cout << "Due to usleeping too little, " + name + " died of a heart failure while looking at Physics Past Papers. \n" << endl;
            usleep(2000000);
            cout << "Game over. \n" << endl;
            usleep(2000000);
